...
public class Validacao {
    ...
    public static boolean hora(String valor){
        ...
        */
        ...
        try{
            hora = Integer.parseInt(Texto.meio(valor, 1, 2));
            minuto = Integer.parseInt(Texto.meio(valor, 4, 2));
            segundo = 0;
            if (valor.length() > 5) 
                segundo = Integer.parseInt(Texto.meio(valor, 7, 2));
    ...
    private static boolean dataManual(String data){
        ...
        try{
            ano = Integer.parseInt(Texto.meio(data, 7));
            mes = Integer.parseInt(Texto.meio(data, 4, 2));
            dia = Integer.parseInt(Texto.meio(data, 1, 2));
    ...
    public static boolean dataHora(String dataHora){
        ...
        if (dataHora.length() == 16 || dataHora.length() == 19) {
            data = Texto.meio(dataHora, 1, 10);
            hora = Texto.meio(dataHora, 12);
    ...
    public static boolean zerado(String valor) throws java.text.ParseException {
    ...
    public  static String gerarDigitoVerificador(String numero,Integer base ){
            ...
            for (Integer i = 1 ; i <= numero.length(); i++){
                dvInsc = dvInsc + Integer.parseInt(Texto.meio(numero, i, 1).toString()) * (((numero.length()  - i) % (base - 1)) + 2);
            }
            dvInsc = dvInsc % 10;
