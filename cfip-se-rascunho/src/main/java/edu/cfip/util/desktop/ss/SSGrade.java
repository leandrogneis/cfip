...
import edu.cfip.util.desktop.ss.tabela.SSModeloColuna;
import edu.cfip.util.desktop.ss.tabela.SSModeloTabela;
import edu.cfip.util.desktop.ss.tabela.TipoSelecao;
