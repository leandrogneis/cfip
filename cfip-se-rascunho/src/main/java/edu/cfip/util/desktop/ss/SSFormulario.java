...
import edu.cfip.util.desktop.ss.util.Reflexao;
import edu.cfip.util.desktop.ss.util.Texto;
import edu.cfip.util.desktop.ss.util.Validacao;
...
public class SSFormulario {
    ...
    public static String validarCampo(SSComponenteRotulado campo, boolean validarCampoObrigatorio)  {
        ...
        if (campo.getTipoValidacao() == null)
            ...
            try {
                Method metodo;
                metodo = Validacao.class.getMethod(campo.getTipoValidacao(), String.class);                
                Object retorno;
    ...
    private static void preencherCampo(SSComponenteRotulado comp, Object objeto) {
        ...
        try {
            valor = Reflexao.buscarValorCampoRecursivo(objeto, comp.getCampoLigacao());
            if (valor == null)
                comp.setText(null);
            else {
                if (comp instanceof SSCampoMascara) {                                        
                    if (comp.getClass() == SSCampoMascara.class && ((SSCampoMascara)comp).getMascara() != null) {
                        comp.setText(Texto.aplicaMascara(valor.toString(), ((SSCampoMascara)comp).getMascara()));  
                    } else {
    ...
    private static void preencherCampoObjeto(SSComponenteRotulado comp, Object objeto) {
        ...
        try {
            ...
            Reflexao.definirValorCampoRecursivo(objeto, comp.getCampoLigacao(), valor);
        } catch (Exception e) {
            //if (e instanceof IllegalAccessException)
