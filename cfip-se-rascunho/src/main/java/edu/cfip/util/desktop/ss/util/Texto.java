...
public class Texto  {
    ...
    public static String primeiraMinuscula(String texto) {
        return Texto.minuscula(Texto.esquerda(texto, 1)) + Texto.meio(texto, 2);
    }
    
    public static String primeiraMaiuscula(String texto) {
        return Texto.maiuscula(Texto.esquerda(texto, 1)) + Texto.meio(texto, 2);
    }
    ...
    public static String seNumero(String valor, String retorno){
        if (valor == null)
            return retorno;
        else if (!Validacao.numero(valor))
            return retorno;
        else
            return valor;
    }
