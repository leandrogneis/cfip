package client.ss.infraestrutura.util;
...
public class Formatador {
    ...
    public static String extensoMonetario(Number numero) {
        ...
        if (numero instanceof BigDecimal)
          ex = new Extenso((BigDecimal)numero);
        else
          ex = new Extenso(numero.doubleValue());
        return ex.toString();
    }
    ...
    public static String formatarCep(String cep) {
        String textoCep = Texto.retiraSeparadores(cep);
        return Texto.aplicaMascara(textoCep, "##.###-###");
    }
    public static String formatarPeriodo(Integer periodo, String formato) {
        ...
        try {
            ...
            if (periodo.toString().length() > 4)
                data = Conversao.data(periodo.toString(), "yyyyMM");
            else
                data = Conversao.data(periodo.toString(), "yyyy");
    ...
    public static String formatarData(java.util.Date dataHora) {
    	return formatar(dataHora,"dd/MM/yyyy");
    }
    public static String formatar(java.util.Date dataHora, String formato) {
        if (dataHora == null)
            return null;
        else {
    ...
    public static String formatar(String texto, String formato) {
        if (texto == null)
            ...
            if (formato.equals(">"))
                ...
                return Texto.aplicaMascara(texto, formato);
        }
    }
    ...
    public static String formatarCpf(Long cpf) {
        String textoCpf = Texto.complementaEsquerda(cpf.toString(), 11, "0");
        return formatarCpf(textoCpf);
    }
    
    public static String formatarCpf(String cpf) {        
        return Texto.aplicaMascara(cpf, "###.###.###-##");
    }
    ...
    public static String formatarCnpj(String cnpj) {        
        ...
        return Texto.aplicaMascara(cnpj, "##.###.###/####-##");
    }
    
    public static String formatarCnpj(Long cnpj) {
        String textoCpf = Texto.complementaEsquerda(cnpj.toString(), 14, "0");
    ...
    public static String formatarCpfCnpj(Long cpfCnpj) {
        if (cpfCnpj.toString().length() > 11)
            ...
            String cpf = Texto.complementaEsquerda(cpfCnpj.toString(), 11, "0");
            if (cpf.length()<14)
    ...
    public static String formatarTelefone(String telefone){
        if (telefone == null)
            return null;
        return Texto.aplicaMascara(telefone, "(##)####-####");
    }
